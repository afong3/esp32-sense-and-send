...
/***********************************/
/*    VL53L7CX ULD power mode      */
/***********************************/
/*
* This example shows the possibility of VL53L7CX to change power mode. It
* initializes the VL53L7CX ULD, set a configuration, change the power mode, and
...
int example4(void)
{
	...
	*/
	...
	if(status)
	{
		printf("vl53l7cx_set_power_mode failed, status %u\n", status);
		return status;
	}
	printf("VL53L7CX is now sleeping\n");
	...
	printf("VL53L7CX is now waking up\n");
